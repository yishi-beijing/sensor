...
static void pvt_callback(const msg_interfaces::msg::Hcinspvatzcb::ConstPtr msg)
{
    ...
    tf2::Quaternion qtn;
    qtn.setRPY(-msg->pitch / 180 * M_PI,msg->roll / 180 * M_PI,  yaw / 180 * M_PI);
    ...
    tf2_quaternion.setRPY( -msg->pitch / 180 * M_PI,msg->roll / 180 * M_PI, yaw / 180 * M_PI);
   // printf("roll  %lf  pitch    %lf yaw  %lf   \n",msg->roll ,-msg->pitch , yaw  );
    float x,y,z,w;
    x=tf2_quaternion.x();
    y=tf2_quaternion.y();
    z=tf2_quaternion.z();
